...
export const schemas = {
  ...
  SubmitScanRequest: {
    ...
    properties: {
      inputType: {
        type: "string",
        enum: ["github", "sbom", "source_zip", "dast"],
        description: "Input type for the scan",
        example: "github",
      },
      inputRef: {
        type: "string",
  ...
  ScanResponse: {
    ...
    properties: {
      ...
      quota_remaining: {
        type: "integer",
        description: "Remaining scans in monthly quota",
      },
    },
  },
  ...
  ListScansRequest: {
    ...
    properties: {
      ...
      created_to: {
        ...
        format: "date-time",
        description:
          "Filter scans created until this date (ISO 8601, optional)",
      },
    },
  },
  ...
  ScanSummary: {
    ...
    properties: {
      ...
      planned_sources: {
        ...
        items: {
          type: "string",
          enum: ["grype", "codescoring_johnny", "snyk", "dast"],
        },
      },
  ...
  ResultsSummary: {
    ...
    properties: {
      free_count: {
        type: "integer",
        description: "Legacy compatibility count for Grype findings",
      },
      enterprise_count: {
        type: "integer",
        description: "Legacy compatibility count for all non-Grype findings",
      },
      total_count: {
        type: "integer",
        description: "Total vulnerabilities across all scanner providers",
      },
      counts_by_source: {
        type: "object",
        additionalProperties: { type: "integer" },
        description: "Findings count grouped by provider-aligned source",
        example: { grype: 12, codescoring_johnny: 5, snyk: 0, dast: 2 },
      },
    },
  },
  ...
  DeltaSummary: {
    ...
    properties: {
      delta_count: {
        type: "integer",
        description:
          "Count of vulnerabilities contributed by the delta calculation",
      },
      delta_by_severity: {
        type: "object",
        additionalProperties: { type: "integer" },
      ...
      is_locked: {
        type: "boolean",
        description: "Always false; delta details are always visible",
      },
    },
  },
  ...
  ActionResponse: {
    ...
    properties: {
      ...
      quota_refunded: {
        type: "integer",
        nullable: true,
        description: "Number of quota units refunded",
      },
    },
  },
  ...
  ScanRate: {
    ...
    properties: {
      ...
      per_week: {
        type: "number",
        format: "double",
        description: "Average scans per week",
      },
    },
  },
  ...
  UpdateScannerAccessRequest: {
    ...
    properties: {
      snyk_api_key: {
        ...
        nullable: true,
        description:
          "User-owned Snyk API key. Empty or null clears the stored key.",
      },
    },
  },
  ...
  Scan: {
    ...
    properties: {
      ...
      userId: {
        type: "string",
        format: "uuid",
        description: "User who created scan",
      },
      status: {
        type: "string",
        enum: ["pending", "scanning", "done", "error", "cancelled"],
  ...
  Vulnerability: {
    ...
    properties: {
      ...
      cvssScore: {
        type: "number",
        format: "float",
        description: "CVSS v3.1 score (0-10)",
      },
      fixedVersion: {
        type: "string",
        nullable: true,
  ...
  ReportResponse: {
    ...
    properties: {
      ...
      lockedView: {
        type: "boolean",
        description:
          "Always false; detailed vulnerability data is always returned",
      },
      severity_breakdown: { $ref: "#/components/schemas/SeverityBreakdown" },
      total_free: {
        type: "integer",
        description: "Legacy compatibility total for Grype findings",
      },
      total_enterprise: {
        type: "integer",
        description: "Legacy compatibility total for all non-Grype findings",
      },
      totals_by_source: {
        type: "object",
        additionalProperties: { type: "integer" },
      ...
      delta_count: {
        type: "integer",
        description: "Enterprise-only findings count",
      },
      vulnerabilities: {
        type: "array",
  ...
  LatestRemediationPayload: {
    ...
    properties: {
      ...
      promptType: {
        type: "string",
        enum: ["quick_fix", "patch", "verification"],
      },
  ...
  UpdateWebhookRequest: {
    ...
    properties: {
      ...
      enabled: {
        type: "boolean",
        description: "Enable/disable webhook (optional)",
      },
      rotateSecret: {
        type: "boolean",
  ...
  MetricsResponse: {
    ...
    properties: {
      total_scans: {
        type: "integer",
        description: "Total scans in time range",
      },
      scans_this_month: {
        type: "integer",
        description: "Scans in current calendar month",
      },
      total_vulnerabilities: {
        type: "integer",
        description: "Active vulnerabilities found",
      },
      avg_severity: {
        type: "string",
        enum: ["CRITICAL", "HIGH", "MEDIUM", "LOW", "INFO"],
  ...
  SavedView: {
    ...
    properties: {
      ...
      sortField: {
        type: "string",
        enum: ["submitted", "target", "type", "status", "findings"],
      },
  ...
  TrendBucket: {
    ...
    properties: {
      ...
      findings: {
        type: "integer",
        description: "Number of active findings in bucket",
      },
      delta: {
        type: "integer",
        description: "Sum of delta findings in bucket",
      },
      findings_by_source: {
        type: "object",
        additionalProperties: { type: "integer" },
  ...
  ProfileResponse: {
    ...
    properties: {
      ...
      org_id: {
        ...
        format: "uuid",
        nullable: true,
        description: "Organization ID if member",
      },
      org_name: {
        type: "string",
        nullable: true,
  ...
  UpdateNotificationSettingsRequest: {
    ...
    properties: {
      project_key: {
        type: "string",
        description:
          "Project identifier for project-scoped notification settings",
        example: "owner/repo",
      },
      email_on_scan_complete: {
        type: "boolean",
