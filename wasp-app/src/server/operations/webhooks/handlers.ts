...
export async function createWebhookApiHandler(request: HandlerRequest, response: Response, context: any) {
  try {
...
export async function listWebhooksApiHandler(_request: HandlerRequest, response: Response, context: any) {
  try {
...
export async function getWebhookApiHandler(request: HandlerRequest, response: Response, context: any) {
  try {
...
export async function updateWebhookApiHandler(request: HandlerRequest, response: Response, context: any) {
  try {
    const body = parseJsonBodyWithLimit<Record<string, unknown>>(request.body);
    const user = await resolveRequestUser(request, context);
    await enforceRateLimit({
...
export async function deleteWebhookApiHandler(request: HandlerRequest, response: Response, context: any) {
  try {
    const user = await resolveRequestUser(request, context);
    await enforceRateLimit({
...
export async function listWebhookDeliveriesApiHandler(
  ...
  try {
    ...
    const result = await listWebhookDeliveries(
      ...
      { user: user || undefined, entities: (context as any).entities },
    );
