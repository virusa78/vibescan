...
import { S3DownloadURL$inboundSchema, S3DownloadURL$outboundSchema, } from "./s3downloadurl.js";
/** @internal */
export const FileDownload$inboundSchema = z.object({
    id: z.string(),
...
/** @internal */
export const FileDownload$outboundSchema = z.object({
    id: z.string(),
...
(function (FileDownload$) {
    ...
    FileDownload$.inboundSchema = FileDownload$inboundSchema;
    /** @deprecated use `FileDownload$outboundSchema` instead. */
    FileDownload$.outboundSchema = FileDownload$outboundSchema;
})(FileDownload$ || (FileDownload$ = {}));
export function fileDownloadToJSON(fileDownload) {
