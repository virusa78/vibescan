...
export const tool$customersGetStateExternal = {
...
**Scopes**: \`customers:read\` \`customers:write\``,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await customersGetStateExternal(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
