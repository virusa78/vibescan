...
export const tool$customersDeleteExternal = {
...
**Scopes**: \`customers:write\``,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await customersDeleteExternal(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
