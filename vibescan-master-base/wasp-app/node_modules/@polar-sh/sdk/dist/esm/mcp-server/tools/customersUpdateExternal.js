...
export const tool$customersUpdateExternal = {
...
**Scopes**: \`customers:write\``,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await customersUpdateExternal(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
