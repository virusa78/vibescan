...
async function $do(client, security, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => customerportallicensekeyslist_js_1.CustomerPortalLicenseKeysListRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
