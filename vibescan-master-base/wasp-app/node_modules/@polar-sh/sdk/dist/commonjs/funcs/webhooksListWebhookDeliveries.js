...
async function $do(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => webhookslistwebhookdeliveries_js_1.WebhooksListWebhookDeliveriesRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
