...
const validationerror_js_1 = require("../components/validationerror.js");
const polarerror_js_1 = require("./polarerror.js");
class HTTPValidationError extends polarerror_js_1.PolarError {
...
exports.HTTPValidationError$inboundSchema = z.object({
    detail: z.array(validationerror_js_1.ValidationError$inboundSchema).optional(),
...
exports.HTTPValidationError$outboundSchema = z.instanceof(HTTPValidationError)
    .transform(v => v.data$)
    .pipe(z.object({
    detail: z.array(validationerror_js_1.ValidationError$outboundSchema).optional(),
}));
/**
 * @internal
