...
exports.licenseKeyWithActivationsToJSON = licenseKeyWithActivationsToJSON;
...
exports.LicenseKeyWithActivations$outboundSchema = z.object({
    ...
    customerId: z.string(),
    customer: licensekeycustomer_js_1.LicenseKeyCustomer$outboundSchema,
    benefitId: z.string(),
    key: z.string(),
    displayKey: z.string(),
...
function licenseKeyWithActivationsToJSON(licenseKeyWithActivations) {
    return JSON.stringify(exports.LicenseKeyWithActivations$outboundSchema.parse(licenseKeyWithActivations));
}
