...
const canonicalEventTypeToCategoryMap = new Map(canonicalEventRegistry.map((entry) => [entry.type, entry.category]));
...
export function isCanonicalEventType(value) {
    return CANONICAL_EVENT_TYPES.includes(value);
}
export function getCanonicalEventCategory(type) {
