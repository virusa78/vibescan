...
const billingDocs = 'wasp-app/src/server/operations/billing/swagger-docs.ts';
const eventsDocs = 'wasp-app/src/server/operations/events/swagger-docs.ts';
const settingsDocs = 'wasp-app/src/server/operations/settings/swagger-docs.ts';
const workspacesDocs = 'wasp-app/src/server/operations/workspaces/swagger-docs.ts';
const onboardingDocs = 'wasp-app/src/server/operations/onboarding/swagger-docs.ts';
const githubDocs = 'wasp-app/src/server/operations/github/swagger-docs.ts';
export const v1EndpointManifest = [
    ...
    { method: 'get', path: '/api/v1/billing/account', operationId: 'getBillingAccount', requiresRequestBody: false, sourceFile: billingDocs },
    { method: 'get', path: '/api/v1/billing/events', operationId: 'listBillingEvents', requiresRequestBody: false, sourceFile: billingDocs },
    { method: 'get', path: '/api/v1/billing/entitlements', operationId: 'getBillingEntitlements', requiresRequestBody: false, sourceFile: billingDocs },
    { method: 'get', path: '/api/v1/events/subscriptions', operationId: 'listEventSubscriptions', requiresRequestBody: false, sourceFile: eventsDocs },
    { method: 'post', path: '/api/v1/events/subscriptions', operationId: 'createEventSubscription', requiresRequestBody: true, sourceFile: eventsDocs },
    { method: 'get', path: '/api/v1/events/deliveries', operationId: 'listEventDeliveries', requiresRequestBody: false, sourceFile: eventsDocs },
    { method: 'get', path: '/api/v1/events/deliveries/{deliveryId}', operationId: 'getEventDelivery', requiresRequestBody: false, sourceFile: eventsDocs },
    { method: 'post', path: '/api/v1/events/deliveries/{deliveryId}/retry', operationId: 'retryEventDelivery', requiresRequestBody: false, sourceFile: eventsDocs },
    ...
    { method: 'post', path: '/api/v1/workspaces/switch', operationId: 'switchWorkspace', requiresRequestBody: true, sourceFile: workspacesDocs },
    { method: 'get', path: '/api/v1/onboarding/state', operationId: 'getOnboardingState', requiresRequestBody: false, sourceFile: onboardingDocs },
    { method: 'post', path: '/api/v1/onboarding/complete', operationId: 'completeOnboarding', requiresRequestBody: false, sourceFile: onboardingDocs },
    { method: 'get', path: '/api/v1/github/installations', operationId: 'listGithubInstallations', requiresRequestBody: false, sourceFile: githubDocs },
    { method: 'post', path: '/api/v1/github/installations/link', operationId: 'linkGithubInstallation', requiresRequestBody: true, sourceFile: githubDocs },
    { method: 'post', path: '/api/v1/github/installations/{installationId}/settings', operationId: 'updateGithubInstallationSettings', requiresRequestBody: true, sourceFile: githubDocs },
];
export function getV1ManifestSwaggerSourceFilesAbsolute() {
    const unique = new Set(v1EndpointManifest.map((entry) => path.resolve(repoRoot, entry.sourceFile)));
    return Array.from(unique).sort();
}
export function getV1FallbackSwaggerGlobsAbsolute() {
    return [
...
//# sourceMappingURL=v1EndpointManifest.js.map