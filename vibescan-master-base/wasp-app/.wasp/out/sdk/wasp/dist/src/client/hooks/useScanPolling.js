...
export function useScanPolling(scanId) {
    ...
    const { data: scanData, error: queryError, refetch, } = useQuery(getScanById, { scanId: scanId || '' }, {
        enabled: !!scanId,
    });
    ...
    useEffect(() => {
        ...
        const updateDisplayState = () => {
            ...
            if (isCompleted)
                ...
                progress = 50; // Running scans show 50% progress
            const newState = {
                scan: {
                    id: scan.id,
                    status: scan.status,
...
//# sourceMappingURL=useScanPolling.js.map