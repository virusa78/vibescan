...
function internalInputTypeFor(inputType) {
    switch (inputType) {
        case "github":
            return "github_app";
        case "sbom":
...
export async function submitScanSubmission(input) {
    ...
    try {
        ...
        console.error(`[scan-submission] Failed to publish quota signals for user ${input.userId}:`, quotaSignalError);
    }
    if (!createdScanId) {
...
//# sourceMappingURL=scanSubmissionService.js.map