...
export type ScannerExecutionPrismaClient = Pick<PrismaClient, 'scan' | 'scanResult' | 'finding' | 'user'>;
...
export type ScannerFindingForPersistence = Pick<NormalizedFinding, 'cveId' | 'severity' | 'package' | 'version' | 'fixedVersion' | 'description' | 'cvssScore'>;
//# sourceMappingURL=scannerExecutionTypes.d.ts.map