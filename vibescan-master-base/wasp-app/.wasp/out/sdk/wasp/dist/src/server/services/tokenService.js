 ...
 * Create a JWT token
 */
function createToken(userId, tokenType) {
    const expirySeconds = tokenType === 'access'
 ...
 */
export async function blacklistToken(jti, expiryTimestamp) {
    try {
