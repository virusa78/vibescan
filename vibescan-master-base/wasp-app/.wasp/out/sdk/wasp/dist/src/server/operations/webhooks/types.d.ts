...
export declare function calculateDeliverySuccessRate(deliveries: WebhookDeliverySummaryRecord[]): number;
export declare function calculateWebhookDeliveryStats(deliveries: Array<{
    status: WebhookDeliveryStatus;
