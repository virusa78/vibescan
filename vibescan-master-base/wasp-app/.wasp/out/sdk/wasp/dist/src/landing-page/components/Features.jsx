...
export default function Features({ features }) {
    return (<div id="features" className="mx-auto mt-48 max-w-7xl px-6 lg:px-8">
      <SectionTitle title={<p className="text-foreground mt-2 text-4xl font-bold tracking-tight sm:text-5xl">
            The <span className="text-secondary">Best</span> Features
          </p>} description="Don't work harder. Work smarter."/>
