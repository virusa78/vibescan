...
import { 
  ...
  type EventDelivery,
  type BillingEventLedger,
  type QuotaLedger,
  type CycloneDxRolloutSnapshot,
  type CycloneDxRolloutState,
} from 'wasp/entities'
...
export type _Entity = 
  ...
  | _BillingEventLedger
  | _QuotaLedger
  | _CycloneDxRolloutSnapshot
  | _CycloneDxRolloutState
  | never
