...
export default function OnboardingPage() {
  ...
  const onboarding = (data ?? null) as OnboardingState | null;
  ...
  return (
    <div className="py-10 lg:mt-10">
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        ...
        {(completeError || (!onboarding?.has_workspace && onboarding)) && (
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-3">
          <Card className="border-border/70 bg-card/90 shadow-sm">
            ...
            <CardContent className="space-y-4">
              ...
              <Button
                className="w-full"
                onClick={() => navigate(`${routes.NewScanRoute.to}?type=github&source=onboarding`)}
              >
                Start with GitHub
          ...
          <Card className="border-border/70 bg-card/90 shadow-sm">
            ...
            <CardContent className="space-y-4">
              ...
              <Button
                variant="outline"
                className="w-full"
                onClick={() => navigate(`${routes.NewScanRoute.to}?type=sbom&source=onboarding`)}
              >
                Start with SBOM
                <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
          ...
          <Card className="border-border/70 bg-card/90 shadow-sm">
            ...
            <CardContent className="space-y-4">
              ...
              <Button
                variant="outline"
                className="w-full"
                onClick={() => navigate(`${routes.NewScanRoute.to}?type=source_zip&source=onboarding`)}
              >
                Start with ZIP
                <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
