...
/** @internal */
export const ProductMediaFileRead$inboundSchema = z.object({
    id: z.string(),
...
/** @internal */
export const ProductMediaFileRead$outboundSchema = z.object({
    id: z.string(),
 ...
 */
export var ProductMediaFileRead$;
(function (ProductMediaFileRead$) {
    /** @deprecated use `ProductMediaFileRead$inboundSchema` instead. */
    ProductMediaFileRead$.inboundSchema = ProductMediaFileRead$inboundSchema;
    /** @deprecated use `ProductMediaFileRead$outboundSchema` instead. */
    ProductMediaFileRead$.outboundSchema = ProductMediaFileRead$outboundSchema;
