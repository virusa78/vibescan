...
/** @internal */
export const TaxIDFormat$inboundSchema = z
    .nativeEnum(TaxIDFormat);
/** @internal */
export const TaxIDFormat$outboundSchema = TaxIDFormat$inboundSchema;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var TaxIDFormat$;
(function (TaxIDFormat$) {
    /** @deprecated use `TaxIDFormat$inboundSchema` instead. */
    TaxIDFormat$.inboundSchema = TaxIDFormat$inboundSchema;
    /** @deprecated use `TaxIDFormat$outboundSchema` instead. */
    TaxIDFormat$.outboundSchema = TaxIDFormat$outboundSchema;
