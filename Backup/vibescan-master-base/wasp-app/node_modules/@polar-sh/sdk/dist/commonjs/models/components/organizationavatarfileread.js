...
exports.OrganizationAvatarFileRead$ = exports.OrganizationAvatarFileRead$outboundSchema = exports.OrganizationAvatarFileRead$inboundSchema = void 0;
exports.organizationAvatarFileReadToJSON = organizationAvatarFileReadToJSON;
exports.organizationAvatarFileReadFromJSON = organizationAvatarFileReadFromJSON;
...
function organizationAvatarFileReadToJSON(organizationAvatarFileRead) {
    return JSON.stringify(exports.OrganizationAvatarFileRead$outboundSchema.parse(organizationAvatarFileRead));
}
function organizationAvatarFileReadFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.OrganizationAvatarFileRead$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'OrganizationAvatarFileRead' from JSON`);
}
