...
async function $do(client, security, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => customerportaldownloadableslist_js_1.CustomerPortalDownloadablesListRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
