...
exports.CustomerOrderSubscription$ = exports.CustomerOrderSubscription$outboundSchema = exports.CustomerOrderSubscription$inboundSchema = void 0;
exports.customerOrderSubscriptionToJSON = customerOrderSubscriptionToJSON;
exports.customerOrderSubscriptionFromJSON = customerOrderSubscriptionFromJSON;
...
/** @internal */
exports.CustomerOrderSubscription$inboundSchema = z.object({
...
/** @internal */
exports.CustomerOrderSubscription$outboundSchema = z.object({
 ...
 */
var CustomerOrderSubscription$;
(function (CustomerOrderSubscription$) {
    /** @deprecated use `CustomerOrderSubscription$inboundSchema` instead. */
    CustomerOrderSubscription$.inboundSchema = exports.CustomerOrderSubscription$inboundSchema;
    /** @deprecated use `CustomerOrderSubscription$outboundSchema` instead. */
    CustomerOrderSubscription$.outboundSchema = exports.CustomerOrderSubscription$outboundSchema;
})(CustomerOrderSubscription$ || (exports.CustomerOrderSubscription$ = CustomerOrderSubscription$ = {}));
function customerOrderSubscriptionToJSON(customerOrderSubscription) {
    return JSON.stringify(exports.CustomerOrderSubscription$outboundSchema.parse(customerOrderSubscription));
}
function customerOrderSubscriptionFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.CustomerOrderSubscription$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'CustomerOrderSubscription' from JSON`);
}
