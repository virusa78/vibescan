...
function buildFoundationNames(user) {
...
export async function ensureWorkspaceFoundationForUser(db, userId) {
...
export async function getWorkspaceContextForUser(db, userId) {
    ...
    const activeMembership = memberships.find((membership) => membership.workspace.id === user.activeWorkspaceId) ??
...
//# sourceMappingURL=workspaceFoundation.js.map