...
import { getAccountDisplayValues, } from "./accountDisplay";
export default function AccountPage() {
    ...
    const { email, planTier, subscriptionStatus, monthlyQuotaUsed, monthlyQuotaLimit, organizationName, organizationSlug, activeWorkspaceName, activeWorkspaceSlug, activeWorkspaceRole, workspaceCount, } = getAccountDisplayValues(user, profile);
