export function normalizeRemediationPromptType(value) {
...
function formatCvssScore(cvssScore) {
    if (typeof cvssScore !== 'number' || !Number.isFinite(cvssScore)) {
        return 'unscored';
    }
    return cvssScore.toFixed(1);
}
export function buildRemediationPromptText(request) {
...
export function buildLocalRemediationDraft(request) {
    ...
    return {
        ...
        responsePayload: {
            ...
            patchGuidance: promptType === 'verification'
                ? [
