...
import type { AuthenticatedUser, QueuedWebhookDeliveryResponse, WebhookOwnershipRecord } from './types.js';
import {
...
async function getOrCreateSyntheticScanId(user: AuthenticatedUser): Promise<any> {
