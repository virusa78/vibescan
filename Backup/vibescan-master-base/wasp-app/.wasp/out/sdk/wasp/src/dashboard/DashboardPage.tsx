...
export default function DashboardPage() {
  ...
  const emptyStateConfig = useMemo(() => {
    const onboarding = (onboardingState ?? null) as OnboardingStateResponse | null;
  ...
  const handleSortChange = (field: DashboardSortField, _event?: React.MouseEvent<HTMLButtonElement>) => {
    ...
    <div className="p-8 lg:p-10">
      ...
      {!hasAnyScans && !isLoading ? (
        <EmptyState
          ...
          actionRoute={emptyStateConfig.actionRoute}
          secondaryActionLabel={emptyStateConfig.secondaryActionLabel}
          secondaryActionRoute={emptyStateConfig.secondaryActionRoute}
        />
      ) : (
        <ScanTable
          scans={tableScans}
